...
class WhatsAppRecipientList(Document):
	...
	def validate_occasion(self):
		"""Invite flow: every imported Occasion Invitee must belong to this
		list's own Occasion - not part of develop's generic recipient list,
		which has no notion of Occasion."""
		if not self.recipients:
			return
