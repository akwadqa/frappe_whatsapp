...
from frappe_whatsapp_new.utils.webhook import (
...
class TestWebhookEndpoint(IntegrationTestCase):
    ...
    def test_webhook_get_verification(self):
        ...
        with patch("frappe_whatsapp_new.utils.webhook.frappe.request", mock_request):
            from frappe_whatsapp_new.utils.webhook import webhook
            response = webhook()
