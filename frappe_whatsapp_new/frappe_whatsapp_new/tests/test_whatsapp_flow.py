...
class TestWhatsAppFlowMessage(FrappeTestCase):
    ...
    def test_flow_message_structure(self):
        ...
        from frappe_whatsapp_new.frappe_whatsapp_new.doctype.whatsapp_message.whatsapp_message import WhatsAppMessage
...
class TestFlowEndpoint(FrappeTestCase):
    ...
    def test_health_check(self):
        ...
        from frappe_whatsapp_new.frappe_whatsapp_new.api.flow_endpoint import handle_init
