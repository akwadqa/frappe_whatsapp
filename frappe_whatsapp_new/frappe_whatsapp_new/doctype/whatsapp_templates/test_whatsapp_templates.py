...
import frappe
from frappe_whatsapp_new.testing import IntegrationTestCase
...
class TestWhatsAppTemplates(IntegrationTestCase):
    ...
    @patch("frappe_whatsapp_new.frappe_whatsapp_new.doctype.whatsapp_templates.whatsapp_templates.make_post_request")
    ...
    @patch("frappe_whatsapp_new.frappe_whatsapp_new.doctype.whatsapp_templates.whatsapp_templates.make_post_request")
    @patch("frappe_whatsapp_new.frappe_whatsapp_new.doctype.whatsapp_templates.whatsapp_templates.make_request")
    ...
    def test_fetch_templates_from_meta(self, mock_post, mock_get, mock_get_password):
        ...
        from frappe_whatsapp_new.frappe_whatsapp_new.doctype.whatsapp_templates.whatsapp_templates import fetch
        result = fetch()
    ...
    def test_upsert_doc_without_hooks(self):
        ...
        from frappe_whatsapp_new.frappe_whatsapp_new.doctype.whatsapp_templates.whatsapp_templates import upsert_doc_without_hooks
