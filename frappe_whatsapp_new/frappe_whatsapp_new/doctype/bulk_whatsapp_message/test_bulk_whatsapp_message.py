...
class TestBulkWhatsAppMessage(IntegrationTestCase):
    ...
    @patch("frappe_whatsapp_new.frappe_whatsapp_new.doctype.whatsapp_message.whatsapp_message.make_post_request")
    ...
    def test_retry_failed(self, mock_post):
        ...
        with patch(
            "frappe_whatsapp_new.frappe_whatsapp_new.doctype.bulk_whatsapp_message.bulk_whatsapp_message.frappe.enqueue_doc"
        ) as mock_enqueue:
            doc.retry_failed()
